...
import static ventanas.Gestionar_insumos.ID_insumo;

/**
 *
 * @author user
 */
public class Gestionar_ingresos extends javax.swing.JFrame {

    public static int ID_ingreso = 0;
    int bandera_mes = 0;
    int bandera_año = 0;
    int bandera_dia = 0;
    String user;
    ...
    public Gestionar_ingresos() {
        ...
        try {
            ...
            model.addColumn("lec_inicial");
            model.addColumn("lec_final");
        ...
        tabla_Ingresos.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (fila_point > -1) {
                    ID_ingreso = (int) model.getValueAt(fila_point, columna_poin);
                    Informacion_Registro mensajero = new Informacion_Registro();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Ingresos Registrados");
    ...
    private void boton_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_buscarActionPerformed
        ...
        if (bandera_año == 0 && bandera_dia == 0 && bandera_mes == 0) {
            JOptionPane.showMessageDialog(null, "para buscar nesecitas lllenar los campos");
        } else if (bandera_dia == 2 && bandera_año == 0 && bandera_mes == 0) {
            try {
                Connection cn = Conexion.conectar();
                PreparedStatement pst = cn.prepareStatement(
                        "select * from ingresos where dia = '" + buscar_dia + "'");
                ResultSet rs = pst.executeQuery();
                tabla_Ingresos = new JTable(model);
                jScroll_ingresos.setViewportView(tabla_Ingresos);
            ...
            try {
                Connection cn = Conexion.conectar();
                PreparedStatement pst = cn.prepareStatement(
                        "select * from ingresos where año = '" + buscar_año + "'");
                ResultSet rs = pst.executeQuery();
                tabla_Ingresos = new JTable(model);
                jScroll_ingresos.setViewportView(tabla_Ingresos);
            ...
            try {
                Connection cn = Conexion.conectar();
                PreparedStatement pst = cn.prepareStatement(
                        "select * from ingresos where mes = '" + buscar_mes + "'");
                ResultSet rs = pst.executeQuery();
                tabla_Ingresos = new JTable(model);
                jScroll_ingresos.setViewportView(tabla_Ingresos);
            ...
            try {
                Connection cn = Conexion.conectar();
                PreparedStatement pst = cn.prepareStatement(
                        "select * from ingresos where año = '" + buscar_año + "' and mes = '" + buscar_mes + "'");
                ResultSet rs = pst.executeQuery();
                tabla_Ingresos = new JTable(model);
                jScroll_ingresos.setViewportView(tabla_Ingresos);
            ...
            try {
                Connection cn = Conexion.conectar();
                PreparedStatement pst = cn.prepareStatement(
                        "select * from ingresos where año = '" + buscar_año + "' and mes = '" + buscar_mes + "'" + "and dia = '" + buscar_dia + "'");
                ResultSet rs = pst.executeQuery();
                tabla_Ingresos = new JTable(model);
                jScroll_ingresos.setViewportView(tabla_Ingresos);
            ...
            try {
                Connection cn = Conexion.conectar();
                PreparedStatement pst = cn.prepareStatement(
                        "select * from ingresos where año = '" + buscar_año + "' and dia = '" + buscar_dia + "'");
                ResultSet rs = pst.executeQuery();
                tabla_Ingresos = new JTable(model);
                jScroll_ingresos.setViewportView(tabla_Ingresos);
            ...
            try {
                Connection cn = Conexion.conectar();
                PreparedStatement pst = cn.prepareStatement(
                        "select * from ingresos where dia = '" + buscar_dia + "' and mes = '" + buscar_mes + "'");
                ResultSet rs = pst.executeQuery();
                tabla_Ingresos = new JTable(model);
                jScroll_ingresos.setViewportView(tabla_Ingresos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gestionar_ingresos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gestionar_ingresos().setVisible(true);
            }
        });
    }
